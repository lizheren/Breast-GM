...
parser.add_argument(
    ...
    default='./../PASCAL_VOC_TO_NPZ-master/Image_files/')
parser.add_argument(
    '-a',
    '--path_to_voc_annotation',
    help='path to VOCdevkit Annotation directory',
    default='./../PASCAL_VOC_TO_NPZ-master/Annotations/')
parser.add_argument(
    '-v',
    '--path_to_voc',
    help='path to VOCdevkit Annotation directory',
    default='./../PASCAL_VOC_TO_NPZ-master/')

parser.add_argument(
    '-o',
    '--path_to_output_npz',
    help='path to VOCdevkit Annotation directory',
    default='./../PASCAL_VOC_TO_NPZ-master/Output/')
